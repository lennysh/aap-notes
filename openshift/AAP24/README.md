...
For RPM deployment on RHEL hosts, see [AAP 2.4 RPM inventory](../../installer/AAP24/rpm/README.md).
...
./generate-aap-cr-examples.sh \
  --crd-dir /path/to/aap-notes/.crd-dumps/2.4 \
  --output-dir /path/to/aap-notes/openshift/AAP24
```
...
Your CRD dump also includes **AnsibleLightspeed** and **Tower resource CRs** (`JobTemplate`, `AnsibleJob`, etc.) with their own secret fields. Those are out of scope for this folder; see the 2.4 CRD dumps under `aap-notes/.crd-dumps/2.4/` for schema reference.
