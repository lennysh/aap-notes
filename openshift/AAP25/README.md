...
For containerized deployment on Linux hosts, see [AAP 2.5 containerized inventories](../../installer/AAP25/containerized/README.md). For RPM deployment, see [AAP 2.5 RPM inventories](../../installer/AAP25/rpm/README.md).
...
For an exhaustive list of every component field, see the generated nested blocks in [`aap.yml`](aap.yml) or the component CRD dumps under `aap-notes/.crd-dumps/2.5/`.
...
python3 generate-aap-cr-examples.py \
  --version 2.5 \
  --crd-dir /path/to/aap-notes/.crd-dumps/2.5 \
  --output-dir /path/to/aap-notes/openshift/AAP25 \
