...
For containerized deployment on Linux hosts, see [AAP 2.7 containerized inventories](../../installer/AAP27/containerized/README.md).
...
Component CRD field reference: `aap-notes/.crd-dumps/2.7/`
...
python3 generate-aap-cr-examples.py \
  --version 2.7 \
  --crd-dir /path/to/aap-notes/.crd-dumps/2.7 \
  --output-dir /path/to/aap-notes/openshift/AAP27 \
