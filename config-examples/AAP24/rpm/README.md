...
For OpenShift operator manifests, see [AAP 2.4 on OpenShift](../openshift/README.md). For maintenance when refreshing after installer updates, see [RPM_INVENTORY_CONTEXT.md](../../RPM_INVENTORY_CONTEXT.md).
