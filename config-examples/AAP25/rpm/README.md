...
For OpenShift operator manifests, see [AAP 2.5 on OpenShift](../openshift/README.md). For containerized deployment, see [AAP 2.5 containerized inventories](../containerized/README.md). For maintenance when refreshing after installer updates, see [RPM_INVENTORY_CONTEXT.md](../../RPM_INVENTORY_CONTEXT.md).
