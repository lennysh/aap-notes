...
For OpenShift operator manifests, see [AAP 2.6 on OpenShift](../openshift/README.md). For containerized deployment, see [AAP 2.6 containerized inventories](../containerized/README.md). For maintenance when refreshing after installer updates, see [RPM_INVENTORY_CONTEXT.md](../../RPM_INVENTORY_CONTEXT.md).
