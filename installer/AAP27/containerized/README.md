...
For OpenShift operator manifests, see [AAP 2.7 on OpenShift](../../openshift/AAP27/README.md). For the shared platform model and optional-variable catalog, see [AAP 2.6 containerized README](../AAP26/containerized/README.md). For maintenance when refreshing after installer updates, see [CONTAINERIZED_INVENTORY_CONTEXT.md](../../maintainer/CONTAINERIZED_INVENTORY_CONTEXT.md).
