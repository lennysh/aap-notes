...
For OpenShift operator manifests, see [AAP 2.5 on OpenShift](../../openshift/AAP25/README.md). For RPM deployment, see [AAP 2.5 RPM inventories](../rpm/README.md). For maintenance when refreshing after installer updates, see [CONTAINERIZED_INVENTORY_CONTEXT.md](../../maintainer/CONTAINERIZED_INVENTORY_CONTEXT.md).
...
Variable definitions live in [`scripts/build_inventory.py`](../../scripts/build_inventory.py). See [CONTAINERIZED_INVENTORY_CONTEXT.md](../../maintainer/CONTAINERIZED_INVENTORY_CONTEXT.md) for the full workflow.
